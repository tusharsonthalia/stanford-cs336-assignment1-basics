...
from cs336_basics.nn_utils import cross_entropy, cosine_learning_rate_schedule, gradient_clipping
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    return train_bpe(input_path, vocab_size, special_tokens, num_processes=4)
